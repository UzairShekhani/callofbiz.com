    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-sm-12 col-lg-6">
                <div class="card">
                    <div class="card-header pb-0">
                        <h5>Basic Accordion</h5><span>Using the <a href="#">card</a> component, you can extend the
            ...
            <div class="col-sm-12 col-lg-6">
                <div class="card">
                    <div class="card-header pb-0">
                        <h5>All Close Accordion</h5><span>Using the <a href="#">card</a> component, you can extend the
                            default collapse behavior to create an accordion.</span>
                    </div>
                    <div class="card-body">
            ...
            <div class="col-sm-12 col-lg-6">
                <div class="card">
                    <div class="card-header pb-0">
                        <h5>Color Accordion</h5><span>Add <code>.bg-*</code> class to add background color with
                            card-header.</span>
                    </div>
                    <div class="card-body">
                                ...
                                <div class="card-header bg-secondary" id="headingeight">
                                    <h5 class="mb-0">
                                        <button class="btn btn-link collapsed text-white" data-bs-toggle="collapse"
                                            ...
                                            aria-controls="collapseeight">Collapsible Group Item
                                            #<span>2</span></button>
                                    </h5>
                                </div>
            ...
            <div class="col-sm-12 col-lg-6">
                <div class="card">
                    <div class="card-header pb-0">
                        <h5>Accordion With Icon on Title</h5><span>Add <code>&lt;i&gt;&lt;/i&gt;</code> tag Along with
                            icon class before title text.</span>
                    </div>
                    <div class="card-body">
            ...
            <div class="col-sm-12 col-lg-6">
                <div class="card">
                    <div class="card-header pb-0">
                        <h5>Accordion open close icon</h5><span>Add <code>&lt;i&gt;&lt;/i&gt;</code> tag Along with icon
